...
<main id="main" class="archive-page archive-aktualnosci py-4 py-lg-5" role="main">
    <div class="container">
                ...
                <?php while (have_posts()) : the_post(); ?>
                    <article <?php post_class('col-12 col-lg-6'); ?>>
                        <div class="p-3 p-lg-4 border rounded-4 h-100">
                            <p class="small text-muted mb-2"><?php echo esc_html(get_the_date()); ?></p>
                            <h2 class="h3 mb-3">
                                <a href="<?php the_permalink(); ?>" class="text-decoration-none"><?php the_title(); ?></a>
                            </h2>
                            <p class="mb-3"><?php echo esc_html(get_the_excerpt()); ?></p>
                            <a href="<?php the_permalink(); ?>" class="btn btn-secondary btn-sm"><?php esc_html_e('Czytam', 'szpnew-wp-theme'); ?></a>
                        </div>
                    </article>
                <?php endwhile; ?>
            </div>
